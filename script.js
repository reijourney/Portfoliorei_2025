...
const volunteers = [
  {
    title: "Anggota Panitia - Titik Temu Official, Batam",
    role: "Divisi Keamanan, MENTAL TALK SESSION oleh Rizky Fadillah",
    period: "Juni 2026",
    details: [
      "Bertanggung jawab menjaga ketertiban dan keamanan selama berlangsungnya acara untuk memastikan kegiatan berjalan dengan lancar dan kondusif.",
      "Mengarahkan serta membantu peserta menuju lokasi acara dan area tempat duduk sesuai dengan konsep acara yang diterapkan.",
      "Memberikan informasi dan panduan kepada peserta terkait alur acara, registrasi, serta tata tertib selama kegiatan berlangsung.",
      "Berpartisipasi dalam rapat teknis dan koordinasi panitia sebelum acara untuk memahami pembagian tugas dan prosedur operasional.",
      "Mendukung pelaksanaan 1 sesi acara yang berlangsung dari pukul 09.00–12.00 WIB dengan memastikan kelancaran arus peserta dan kenyamanan selama kegiatan."
    ],
    // Tambahkan properti imageSrcs untuk gambar-gambar volunteer
    imageSrcs: [
      "img/volunteer/mts/mts1.jpg", // Ganti dengan jalur gambar sebenarnya
      "img/volunteer/mts/mts2.jpg", // Ganti dengan jalur gambar sebenarnya
      "img/volunteer/mts/mts3.jpg", // Ganti dengan jalur gambar sebenarnya
      "img/volunteer/mts/mts4.jpg", // Ganti dengan jalur gambar sebenarnya
    ]
  },
  {
