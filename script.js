const experiences = [
  {
    ...
    details: [
      "Membuat desain mata ayam untuk spanduk sesuai kebutuhan klien.",
      "Menghasilkan desain grafis yang menarik dan sesuai dengan standar perusahaan.",
      "Mengantarkan spanduk yang telah dipesan oleh klien, termasuk perusahaan Pajak DGT.",
  ...
  },
  {
    ...
    details: [
      ...
      "Membuat konten visual untuk kebutuhan promosi di media sosial, seperti Instagram dan Facebook.",
...
const volunteers = [
  {
    title: "Volunteer – Eufornice Fest Vol. II, Batam",
    role: "Liaison Officer, for Artist 'For Revenge'",
  ...
  {
    title: "Commite Member – Ayah Amanah Event, Batam",
    role: "Facilities Division, SHARING TIME by UHA (Ust. Hanan Attaki, Lc.)",
  ...
  {
    title: "Photographer – Badan Eksekutif Mahasiswa Polibatam",
    role: "Documentation Division, Young Staff Social Service Event 2024",
...
const certifications = [
  {
    ...
    date: "Januari 2025",
    skills: ["UI/UX Design", "User Interface", "Prototyping"],
    imageSrc: "img/Certif1.jpg" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
    ...
    imageSrc: "img/Certif2.jpg" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
    ...
    imageSrc: "img/Certif3.png" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
    ...
    imageSrc: "img/Certif4.png" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
    ...
    imageSrc: "img/Certif5.jpg" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
    ...
    imageSrc: "img/Certif6.jpg" // GANTI DENGAN PATH GAMBAR ANDA
  },
  {
  ...
  },
  {
    ...
    imageSrc: "img/Certif8.jpg" // GANTI DENGAN PATH GAMBAR ANDA
  }
];
...
function populateVolunteers() {
    ...
    volunteers.forEach((vol) => {
        const card = document.createElement('div');
        card.className = 'experience-card bg-white p-6 rounded-xl shadow-lg transition-all duration-300 ease-in-out'; // Reusing experience-card style for consistency
        card.innerHTML = `
            <div class="flex justify-between items-start">
                <div>
...
function populateCertifications() {
  ...
  certifications.forEach(cert => {
    const card = document.createElement('div');
    // Anda bisa membuat class CSS baru 'certification-card' atau menggunakan 'project-card' jika gayanya mirip
    card.className = 'bg-white p-6 rounded-xl shadow-lg flex flex-col text-left'; // Tailwind classes for card
    card.innerHTML = `
        <img src="${cert.imageSrc}" alt="Sertifikat ${cert.title}" class="w-full h-48 object-contain mb-4 rounded-md border border-stone-200" onerror="this.onerror=null;this.src='https://placehold.co/400x250/E2E8F0/A0AEC0?text=Gambar+Sertifikat';">
        <div>
